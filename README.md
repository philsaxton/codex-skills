...
From the root of the project where you want to use the skills, add this repository as a submodule under `.agents/vendors/`, outside Codex's skill-discovery directory:

```sh
git submodule add https://github.com/philsaxton/codex-skills.git .agents/vendors/codex-skills
```
...
```sh
./.agents/vendors/codex-skills/scripts/link-skills.sh contract-author contract-reviewer
```
...
ln -s ../vendors/codex-skills/contract-author .agents/skills/contract-author
```
