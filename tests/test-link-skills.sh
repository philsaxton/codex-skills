...
cp "$source_repo/link-skills.sh" "$fixture/vendor/codex-skills/link-skills.sh"

cd "$fixture"
./vendor/codex-skills/link-skills.sh alpha
...
if ./vendor/codex-skills/link-skills.sh missing >/dev/null 2>&1; then
...
if ./vendor/codex-skills/link-skills.sh alpha >/dev/null 2>&1; then
