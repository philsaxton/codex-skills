...
- **Current disposition:** Implemented and independently verified (2026-08-26). Fresh RED evidence in task `01a03c1c-cc04-7a32-ba98-ed865ca00545` showed repeated reviewer-specific authority drift across software, operational, and inferred-basis cases, while redlining and completed-deliverable boundaries remained distinct. The independently designed [contract-reviewer skill](contract-reviewer/SKILL.md) preserves authorship, separates findings, questions, non-binding options, and readiness, and keeps inference provisional. Post-artifact comparison tested possible source-derived omissions independently and rejected them when no baseline failure appeared. Exact artifact `4c38cd7c6d53fa82239ebd0dc3cf10356d2d28ae` was verified read-only in task `01a03c3f-3adc-7ae1-ae84-269a51877fd9`.
...
- **Current disposition:** Evidence-tested hold (2026-08-25; fresh task `01a03c1c-cbfb-7531-a2d4-71b5af10ffe7`). Formal-contract controls across completed software, automation, and operational-document deliverables already inspected current artifacts, challenged passing checks, traced outcomes to criteria, reported residual risk, avoided editing, and issued appropriately scoped rejection decisions without a target skill. Two materially different no-contract controls did omit a clear inferred-intent/general-review label, an invitation to correct the inferred basis, and a clean separation between provisional evidence and authority. That recurring gap warrants further testing, but the present evidence does not establish a distinct skill rather than a focused extension to existing review guidance. Do not author until independent trials show a broader standalone final-judgment gap beyond ordinary review and verification.
...
- **Current disposition:** Evidence-tested hold (2026-08-25; fresh task `01a03c1c-cbfb-7531-a2d4-71960d7ed7c8`). Across software, configuration, operational, and documentation controls, ordinary baseline behavior plus existing planning, TDD, workspace, coordination, and verification guidance already preserved scope and unrelated work, produced proportionate checks, surfaced risks, handed off evidence, and avoided self-acceptance. Three materially different no-contract controls did repeatedly convert reasonable inferences into settled execution criteria without labeling their evidence, provisional status, or uncertainty. That narrow provenance gap is portable, but it does not yet justify a broad standalone implementer role with substantial overlap. Do not author until further independent evidence shows a compact execution-owner discipline that existing implementation skills do not already supply.
...
- **Current disposition:** Implemented and independently verified (2026-08-26). Fresh neutral baselines showed mixed behavior without the target skill: some agents kept operations separate, while others chained independently meaningful inspection, staging, verification, and commit work; a readable pipeline remained one data flow, and an indirection control used direct calls. The [running-discrete-shell-commands skill](running-discrete-shell-commands/SKILL.md) applies the smallest portable command-shape rule without changing authorization or project policy. Exact combined artifact `a6f65fdaf6f6d027c6d52b60c7ac6affb0cb9078` and skill SHA-256 `edcf9fb8d459d611f9b8a376eb091afb9f74d802b008d7e41f9f83d0718dded6` were independently verified in task `01a03c26-53b5-76d1-b655-6c070860454a`; the reviewer explicitly retained the generic platform command-separation guidance as a baseline confound rather than hiding it.
